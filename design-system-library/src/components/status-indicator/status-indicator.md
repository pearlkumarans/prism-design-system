...
| Axis | Values | Count |
|------|--------|------:|
| `Status` | Neutral (default), Success, Warning, Critical, Info, Alert | 6 |
| `Size` | Small (default), Medium, Large | 3 |
| `State` | Default, Hover, Disabled | 3 |

**Total:** 6 × 3 × 3 = **54 variants**

> **Alert** (amber) sits between Warning (orange) and Info — used for expiry / attention states. Dot = `--uems-bg-alert-solid`.
